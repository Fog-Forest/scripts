...
class_replace_words2 = {"电影-情": "剧情", "电影-喜": "喜剧", "电影-网络电影": "网络", "电影-动画电影": "动画", "电视-情": "剧情", "电视-喜": "喜剧",
                        ...
                        "bilibili-番": "番剧", "B站电影": "电影", "B站国创": "国创", "B站电视": "电视剧", "0-3岁": "早教", "4-6岁": "少儿",
...
def get_vod_data():
    ...
    cursor = db.cursor()
    # SQL 查询语句
    sql = "SELECT vod_id,vod_class,vod_area FROM mac_vod ORDER BY vod_id DESC LIMIT 100"
    try:
        cursor.execute(sql)
        # 获取所有记录列表
...
if __name__ == "__main__":
    main()
    # 替换资源图片链接
    run_sql('UPDATE mac_vod SET vod_pic = REPLACE(vod_pic, "r1.ykimg.com", "r2.ykimg.com")')
